import math
""" this is just me not knoiwng how to shrink the code, used help to shrink it. this is my raw
code, it has no comments other then some i found from a function i repurposed. this is just to show the full work """
def part_awesome():
    ...
    b = [15, -35, 94, 1]
    Cholesky_Decomposition(matrix, b, n)
...
def part_brownie():
        ...
        # Driver Code
        n = 4
        matrix = [[4,2,4,0],[2,2,3,2],[4,3,6,3],[0,2,3,9]]
        b = [20,36,60,122]
        Cholesky_Decomposition(matrix, b, n)
print("solution to Cholesky decomposition part a:")
print(part_awesome())
print("solution to Cholesky decomposition part b:")
print(part_brownie())